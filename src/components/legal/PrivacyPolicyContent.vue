...
<p>Our Privacy Policy was posted on 19 June 2020 and last updated on 19 Jun 2020. It governs the privacy terms of our website, located at Stutor.com, and the tools we provide you (the "Website" or the "Service"). Any capitalized terms not defined in our Privacy Policy, have the meaning as specified in our Terms of Use accessible at <router-link :to="{name: 'TermsOfUse'}">https://stutor.com/legal/terms-of-use</router-link></p>
...
<p>While using our Service, we may ask you to provide us with certain personally identifiable information that can be used to contact or identify you ("Personal Data"). Personally identifiable information may include, but is not limited to: Email address, Name, Phone number, Address, State, Province, ZIP/Postal code, City, Cookies and Usage Data.</p>
...
<ul>
<li>
<strong>Stripe.</strong> Their Privacy Policy can be viewed at <a href="https://stripe.com/privacy">https://stripe.com/privacy</a>
</li>
</ul>
...
<p>If you have any questions about this Privacy Policy, please contact us by using the contact information <router-link :to="{name: 'ContactUs'}">we provided on our Contact page</router-link>.</p>
    </div>
</template>
